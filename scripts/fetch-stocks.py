...
GEMINI_URL = f"https:import yfinance as yf
import json, os, re, time, requests
from datetime import datetime, timezone
...
print(f"\n✅ Fertig! {len(results)} Aktien gespeichert.")//generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key={GEMINI_API_KEY}"
